...
public class Personne implements Serializable{
	...
	@JoinTable(name="PersonneMatiere", joinColumns= @JoinColumn(name="id_personne", referencedColumnName="idPersonne"), inverseJoinColumns = 
	@JoinColumn(name="id_matiere", referencedColumnName="idMatiere"))
	private Set<Matiere> matieres = new HashSet<>();
	
	@ManyToMany(fetch = FetchType.EAGER) 
	@JoinTable(name="Profil", joinColumns= @JoinColumn(name="id_personne", referencedColumnName="idPersonne"), inverseJoinColumns = 
	@JoinColumn(name="id_rolee", referencedColumnName="idRole"))
